...
function AdminLayout() {
    ...
    const token = localStorage.getItem('admin-token')
        ...
        const handleLogout = () => {
            localStorage.removeItem('admin-token'); // Clear the token
                ...
                <div className="navbar bg-blue-900 text-white">
                   ...
                   {token && (
                    <ul className="flex justify-between space-x-4">
                       <li onClick={() => navigate("/admin/adminhome")}><a>Home</a></li>
                       <li onClick={() => navigate("/admin/theaters")}><a>Theaters</a></li>
                       <li onClick={() => navigate("/admin/userslist")}><a>Users</a></li>
